...
* Modified for IssueTrack (just the template)
*
...
(function() {
    ...
    template = '<div class="list"><div class="col">{{#if isLoading}}loading...{{else}}{{#if canLoadMore}}<a {{action "loadMore" }}>click to load more</a>{{else}}<strong><em>no more items</em></strong>{{/if}}{{/if}}</div></div>';
